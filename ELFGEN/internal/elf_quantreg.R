...
# function inputs with default = NULL are unused and may be removed in the future
elf_quantreg <- function(
  inputs, data, x_metric_code, y_metric_code, ws_ftype_code = NULL, 
  Feature.Name_code, Hydroid_code = NULL, search_code = NULL, token, 
  startdate, enddate){
