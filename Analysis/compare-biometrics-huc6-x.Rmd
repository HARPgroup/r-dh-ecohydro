...
batch <- data.frame(
    bundle = 'watershed', ftype = 'nhd_huc6', dataset_tag = 'bpj-huc6-rcc', q_ftype = 'fe_elf', metric = 'aqbio_nt_total')

# bpj-rcc
batch <- rbind(
  batch, data.frame(
    bundle = 'watershed', ftype = 'nhd_huc6', dataset_tag = 'BenthicPWITupdate', q_ftype = 'fe_pwit', metric = 'aqbio_nt_total')
)

# bpj-rcc
batch <- rbind(
  batch, data.frame(
    bundle = 'watershed', ftype = 'nhd_huc6', dataset_tag = 'bpj-huc6-rcc', q_ftype = 'fe_elf', metric = 'aqbio_nt_minnow')
)

# Using 75% value from ymax analysis of all HUC8s
batch <- rbind(
  batch, data.frame(
    bundle = 'watershed', ftype = 'nhd_huc6', dataset_tag = 'bpj-huc6-rcc', q_ftype = 'fe_elf', metric = 'aqbio_nt_cent')
)

# Using 75% value from ymax analysis of all HUC8s
batch <- rbind(
  batch, data.frame(
    bundle = 'watershed', ftype = 'nhd_huc6', dataset_tag = 'bpj-huc6-rcc', q_ftype = 'fe_elf', metric = 'aqbio_nt_benins')
)

# darter
batch <- rbind(
  batch, data.frame(
    bundle = 'watershed', ftype = 'nhd_huc6', dataset_tag = 'bpj-huc6-rcc', q_ftype = 'fe_elf', metric = 'aqbio_nt_darter')
)

# Using 75% value from ymax analysis of all HUC8s
batch <- rbind(
  batch, data.frame(
    bundle = 'watershed', ftype = 'nhd_huc6', dataset_tag = 'bpj-huc6-rcc', q_ftype = 'fe_elf', metric = 'aqbio_nt_native')
)
...
names(ss) <- c("Biometric",'Med R(all/max/DA/Qmean/Best)',"Count","Criteria");
