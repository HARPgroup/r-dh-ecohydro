...
batch <- rbind(
  batch, data.frame(
    bundle = 'watershed', ftype = 'nhd_huc6', dataset_tag = 'bpj-huc6-rcc', q_ftype = 'fe_elf', metric = 'aqbio_nt_darter', title = "HUC8 - # of Taxa Darters")
)

# bpj-rcc
batch <- rbind(
  batch, data.frame(
    bundle = 'watershed', ftype = 'nhd_huc6', dataset_tag = 'bpj-huc6-rcc', q_ftype = 'fe_elf', metric = 'aqbio_nt_minnow', title = "HUC8 - # of Taxa True Minnows")
)

# Using 75% value from ymax analysis of all HUC8s
batch <- rbind(
  batch, data.frame(
    bundle = 'watershed', ftype = 'nhd_huc6', dataset_tag = 'bpj-huc6-rcc', q_ftype = 'fe_elf', metric = 'aqbio_nt_cent', title = "HUC8 - # of Taxa Centrarchids")
)

# Using 75% value from ymax analysis of all HUC8s
batch <- rbind(
  batch, data.frame(
    bundle = 'watershed', ftype = 'nhd_huc6', dataset_tag = 'bpj-huc6-rcc', q_ftype = 'fe_elf', metric = 'aqbio_nt_benins', title = "HUC8 - # of Taxa Benthic Insectivores")
)

# Using 75% value from ymax analysis of all HUC8s
batch <- rbind(
  batch, data.frame(
    bundle = 'watershed', ftype = 'nhd_huc6', dataset_tag = 'bpj-huc6-rcc', q_ftype = 'fe_elf', metric = 'aqbio_nt_cypr_native', title = "HUC8 - # of Taxa Native Cyprinidae")
)
