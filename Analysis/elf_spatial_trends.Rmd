...
huc8_rawdata = 
  fn_dh_elfstats ( ftype = 'fe_elf', 
    ...
    stat_quantreg_glo = 'all', dataset_tag = 'bpj-huc6bp-rcc'
  );
...
write.csv(data.table.hucinfo, file = paste(save_directory, "HUC6_8_10_NTTotal.csv", sep=""), row.names = FALSE, quote = FALSE)
