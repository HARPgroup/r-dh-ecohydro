...
huc6_xvar_data = subset(huc6_xvar_data, out_m > 0)
huc6_xvar_data = subset(huc6_xvar_data, out_rsq_adj > 0)
huc6_xvar_data = subset(huc6_xvar_data, out_p <= 0.01)
...
huc8_xvar_data = subset(huc8_xvar_data, out_m > 0)
huc8_xvar_data = subset(huc8_xvar_data, out_rsq_adj > 0)
huc8_xvar_data = subset(huc8_xvar_data, out_p <= 0.01)

#huc8_anova_data = huc8_rawdata;
#huc8_anova_data = subset(huc8_anova_data, out_m > 0)
#huc8_anova_data = subset(huc8_anova_data, out_rsq_adj > 0)
#huc8_anova_data = subset(huc8_anova_data, out_p <= 0.01)
...
huc10_xvar_data = subset(huc10_xvar_data, out_m > 0)
huc10_xvar_data = subset(huc10_xvar_data, out_rsq_adj > 0)
huc10_xvar_data = subset(huc10_xvar_data, out_p <= 0.01)
...
ecoiii_xvar_data = subset(ecoiii_xvar_data, out_m > 0)
ecoiii_xvar_data = subset(ecoiii_xvar_data, out_rsq_adj > 0)
ecoiii_xvar_data = subset(ecoiii_xvar_data, out_p <= 0.01)
