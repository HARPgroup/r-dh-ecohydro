...
plot_monthly <- function (data, subname = 'all', metric = "out_rsq_adj") {
...
bundle <- 'watershed'; # ecoregion, landunit
ftype <- 'nhd_huc8'; # ecoregion_iii
...
# render it
plot_monthly(data, '( p<0.01, R>0 )', metric = 'out_rsq_adj');
plot_monthly(data, '( p<0.01, R>0 )', metric = 'out_m');
...
data = subset(data, out_rsq_adj > Rmin)
data = subset(data, isheadwater > 0)
plot_monthly(data, '( headwaters, p<0.01, R>0 )');
