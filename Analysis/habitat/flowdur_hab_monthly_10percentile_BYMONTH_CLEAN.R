...
#ifim_sites <- c(397302) #Dunlap
#ifim_sites <- c(397303) #Craig
site.key <- c(397290) #Plains Mill 

ifim_sites <- ifim_sites[which(ifim_sites$V1 == site.key),]
...
qmax <- max(ifim_dataframe$discharge)
  ...
  #Only consider coverage at flows at the 10th percentile and below 
#  tenth_percentile <- as.numeric(quantile(data$Flow, probs = c(0.10)))
#  data <- data[which(data$Flow < tenth_percentile), ]
  ...
  Total_data <- data
  Total_tenth_percentile <- as.numeric(quantile(Total_data$Flow, probs = c(0.10)))
  Total_data <- data[which(Total_data$Flow < Total_tenth_percentile), ]
  ...
  Jan_tenth_percentile <- as.numeric(quantile(Jan_data$Flow, probs = c(0.10)))
  Jan_data <- data[which(Jan_data$Flow < Jan_tenth_percentile), ]
  ...
  Feb_tenth_percentile <- as.numeric(quantile(Feb_data$Flow, probs = c(0.10)))
  Feb_data <- data[which(Feb_data$Flow < Feb_tenth_percentile), ]
  ...
  Mar_tenth_percentile <- as.numeric(quantile(Mar_data$Flow, probs = c(0.10)))
  Mar_data <- data[which(Mar_data$Flow < Mar_tenth_percentile), ]
  ...
  Apr_tenth_percentile <- as.numeric(quantile(Apr_data$Flow, probs = c(0.10)))
  Apr_data <- data[which(Apr_data$Flow < Apr_tenth_percentile), ]
  ...
  May_tenth_percentile <- as.numeric(quantile(May_data$Flow, probs = c(0.10)))
  May_data <- data[which(May_data$Flow < May_tenth_percentile), ]
  ...
  Jun_tenth_percentile <- as.numeric(quantile(Jun_data$Flow, probs = c(0.10)))
  Jun_data <- data[which(Jun_data$Flow < Jun_tenth_percentile), ]
  ...
  Jul_tenth_percentile <- as.numeric(quantile(Jul_data$Flow, probs = c(0.10)))
  Jul_data <- data[which(Jul_data$Flow < Jul_tenth_percentile), ]
  ...
  Aug_tenth_percentile <- as.numeric(quantile(Aug_data$Flow, probs = c(0.10)))
  Aug_data <- data[which(Aug_data$Flow < Aug_tenth_percentile), ]
  ...
  Sep_tenth_percentile <- as.numeric(quantile(Sep_data$Flow, probs = c(0.10)))
  Sep_data <- data[which(Sep_data$Flow < Sep_tenth_percentile), ]
  ...
  Oct_tenth_percentile <- as.numeric(quantile(Oct_data$Flow, probs = c(0.10)))
  Oct_data <- data[which(Oct_data$Flow < Oct_tenth_percentile), ]
  ...
  Nov_tenth_percentile <- as.numeric(quantile(Nov_data$Flow, probs = c(0.10)))
  Nov_data <- data[which(Nov_data$Flow < Nov_tenth_percentile), ]
  ...
  Dec_tenth_percentile <- as.numeric(quantile(Dec_data$Flow, probs = c(0.10)))
  Dec_data <- data[which(Dec_data$Flow < Dec_tenth_percentile), ]
  ...
  ggplot(df, aes(x = reorder(month, order), y = pct))+
    ...
    labs(title = paste("Percent Monthly Historic Gage Flow Coverage by WUA Table (10th PERCENTILE AND BELOW)",sep=""),
