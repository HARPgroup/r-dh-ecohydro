...
benthics <- data.frame(ifim_site_name = character(),
  ...
  # benthics <- rbind(benthics, all_sites[which(all_sites$metric=="alg_mid"),])        # Algae and Midge Guild
 #  benthics <- rbind(benthics, all_sites[which(all_sites$metric=="bd_high_grad"),])    # Benthos Diversity, high gradient
 #  benthics <- rbind(benthics, all_sites[which(all_sites$metric=="bd_low_grad"),])     # Benthos Diversity, low gradient
 #  benthics <- rbind(benthics, all_sites[which(all_sites$metric=="benth_mac"),])       # Benthic Macroinvertebrates
 #  benthics <- rbind(benthics, all_sites[which(all_sites$metric=="cf"),])              # Crayfish
 #  benthics <- rbind(benthics, all_sites[which(all_sites$metric=="e_comp"),])          # Eastern Elliptio mussel, Elliptio complanata
   benthics <- rbind(benthics, all_sites[which(all_sites$metric=="eph_mac"),])         # Mayfly
#   benthics <- rbind(benthics, all_sites[which(all_sites$metric=="l_rad"),])           # Eastern lampmussel
   benthics <- rbind(benthics, all_sites[which(all_sites$metric=="plec_mac"),])        # Stonefly
 #  benthics <- rbind(benthics, all_sites[which(all_sites$metric=="pwb"),])             # Purple Wartyback mussel
#   benthics <- rbind(benthics, all_sites[which(all_sites$metric=="sm_shal_slow"),])    # Spike Mussel, Shallow
#   benthics <- rbind(benthics, all_sites[which(all_sites$metric=="sm_int"),])          # Spike Mussel, Intermediate
   benthics <- rbind(benthics, all_sites[which(all_sites$metric=="tric_mac"),])        # Caddisfly
