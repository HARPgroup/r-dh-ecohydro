...
names(ts1) <- c('Date', 'Flow')
ts2 <- ts1
ts2$Flow <- 0.6 * ts1$Flow
ts3 <- ts1
ts3$Flow <- 0.2 * ts1$Flow


ifim_plot05 <- ifim_wua_change_plot(ts1, ts2, WUA.df, 0.05,"ifim_da_sqmi" = ifim_da_sqmi,runid_a = "11",metric_a = "Qbaseline",runid_b = "11",metric_b = "Qout")
ifim_plot05 + ylim(c(-50,50))

ifim_plot10 <- ifim_wua_change_plot(ts1, ts2, WUA.df, 0.1,"ifim_da_sqmi" = ifim_da_sqmi,runid_a = "11",metric_a = "Qbaseline",runid_b = "11",metric_b = "Qout")
ifim_plot10 + ylim(c(-50,50))

ifim_plot100 <- ifim_wua_change_plot(ts1, ts2, WUA.df, 1.0,"ifim_da_sqmi" = ifim_da_sqmi,runid_a = "11",metric_a = "Qbaseline",runid_b = "11",metric_b = "Qout")
ifim_plot100 + ylim(c(-50,50))
ifim_plot100

ifim_plot1020 <- ifim_wua_change_plot(ts1, ts3, WUA.df, 0.5,"ifim_da_sqmi" = ifim_da_sqmi,runid_a = "11",metric_a = "Qbaseline",runid_b = "11",metric_b = "Qout")
ifim_plot1020 + ylim(c(-50,50))
ifim_plot1020
om_flow_table(ts1, 'Flow')
