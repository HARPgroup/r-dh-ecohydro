...
Dunlap.huc8.stats.bpj_rcc <- fn_dh_elfstats(feature_ftype = 'nhd_huc8',yvar = 'aqbio_nt_total',xvar = xvar,sampres = 'species',stat_quantreg_qu = "0.80",dataset_tag = 'bpj-huc6bp-rcc',featureid = Dunlap.huc8.hydroid)
...
Craig.huc8.stats.bpj_rcc <- fn_dh_elfstats(feature_ftype = 'nhd_huc8',yvar = 'aqbio_nt_total',xvar = xvar,sampres = 'species',stat_quantreg_qu = "0.80",dataset_tag = 'bpj-rcc',featureid = Craig.huc8.hydroid)
...
huc8_Dunlap.huc10.m <- Dunlap.huc8.stats.bpj_rcc$out_m
huc8_Dunlap.huc10.b <- Dunlap.huc8.stats.bpj_rcc$out_b
huc8_Dunlap <- ((huc8_Dunlap.huc10.m*(log((1)/(1-(as.numeric(pctchg)/100)))))/(huc8_Dunlap.huc10.m*(log(Dunlap.erom_q0001e_mean))+huc8_Dunlap.huc10.b))*100

huc8_PlainsMill.huc10.m <- PlainsMill.huc8.stats.bpj_rcc$out_m
huc8_PlainsMill.huc10.b <- PlainsMill.huc8.stats.bpj_rcc$out_b
huc8_PlainsMill <- ((huc8_PlainsMill.huc10.m*(log((1)/(1-(as.numeric(pctchg)/100)))))/(huc8_PlainsMill.huc10.m*(log(PlainsMill.erom_q0001e_mean))+huc8_PlainsMill.huc10.b))*100

huc8_NorthAnna.huc10.m <- NorthAnna.huc8.stats.bpj_rcc$out_m
huc8_NorthAnna.huc10.b <- NorthAnna.huc8.stats.bpj_rcc$out_b
huc8_NorthAnnaPiedmont <- ((huc8_NorthAnna.huc10.m*(log((1)/(1-(as.numeric(pctchg)/100)))))/(huc8_NorthAnna.huc10.m*(log(NorthAnnaPiedmont.erom_q0001e_mean))+huc8_NorthAnna.huc10.b))*100
huc8_NorthAnnaFallZone <- ((huc8_NorthAnna.huc10.m*(log((1)/(1-(as.numeric(pctchg)/100)))))/(huc8_NorthAnna.huc10.m*(log(NorthAnnaFallZone.erom_q0001e_mean))+huc8_NorthAnna.huc10.b))*100

huc8_Craig.huc10.m <- Craig.huc8.stats.bpj_rcc$out_m
huc8_Craig.huc10.b <- Craig.huc8.stats.bpj_rcc$out_b
huc8_Craig <- ((huc8_Craig.huc10.m*(log((1)/(1-(as.numeric(pctchg)/100)))))/(huc8_Craig.huc10.m*(log(Craig.erom_q0001e_mean))+huc8_Craig.huc10.b))*100
################################################################################################################
################################################################################################################
################################################################################################################
################################################################################################################
...
export <- cbind(export,huc_unit = c("huc10","huc8","huc10","huc10","huc10"))
export <- cbind(export,huc8_taxachg = -c(huc8_Dunlap,huc8_PlainsMill,huc8_NorthAnnaPiedmont,huc8_NorthAnnaFallZone,huc8_Craig))
