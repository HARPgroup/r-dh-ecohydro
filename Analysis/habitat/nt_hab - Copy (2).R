...
#----------------------------------------------------- 
#----------------------------------------------------- 
plot_labels <- data.frame(ifim_site_name=c("Dunlap",
                                           "Plains Mill",
                                           "North Anna Piedmont",
                                           "North Anna Fall Zone",
                                           "Craig"),
...
plot(month_data_medians$taxa_chg, month_data_medians$pctchg,
     ...
     ylab="Percent Change Habitat",cex.lab=1.4,
     cex.axis=2,
     #ylim=c(-80,80))
     #ylim=c(-12,12),
     #xlim=c(-12,12))
...
summary(lm(month_data_medians$pctchg ~ month_data_medians$taxa_chg))
