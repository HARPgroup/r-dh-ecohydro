...
# vars
yvar = 'aqbio_nt_darter';#aqbio_nt_total, aqbio_nt_cent, aqbio_nt_darter, aqbio_nt_benins, aqbio_nt_minnow, aqbio_nt_cypr_native
xvar = 'erom_q0001e_mean';
graphtitle = "# of Taxa Darters"
quant = 0.8
pmin <- 0.01
Rmin <- 0.0
mmin <- 0
...
huc8_rawdata = 
  fn_dh_elfstats ( ftype = 'fe_elf', 
    ...
    stat_quantreg_glo = 'all', dataset_tag = 'bpj-huc6bp-darter'
  );
