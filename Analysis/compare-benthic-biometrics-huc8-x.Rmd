...
# aqbio_benthic_nt_ept
batch <- rbind(
  batch, data.frame(
    bundle = 'watershed', ftype = 'nhd_huc8', dataset_tag = 'benthic-rcc-175', q_ftype = 'fe_elf', metric = 'aqbio_benthic_nt_ept')
)

# aqbio_benthic_nt_ephem
batch <- rbind(
  batch, data.frame(
    bundle = 'watershed', ftype = 'nhd_huc8', dataset_tag = 'benthic-rcc-175', q_ftype = 'fe_elf', metric = 'aqbio_benthic_nt_ephem')
)

# aqbio_benthic_nt_tol
batch <- rbind(
  batch, data.frame(
    bundle = 'watershed', ftype = 'nhd_huc8', dataset_tag = 'benthic-rcc-175', q_ftype = 'fe_elf', metric = 'aqbio_benthic_nt_tol')
)

# aqbio_benthic_nt_intol
batch <- rbind(
  batch, data.frame(
    bundle = 'watershed', ftype = 'nhd_huc8', dataset_tag = 'benthic-rcc-175', q_ftype = 'fe_elf', metric = 'aqbio_benthic_nt_intol')
)
