...
huc6_rawdata = 
  ...
  stat_quantreg_glo = 'all', dataset_tag = 'bpj-q50'
);
...
huc10quant = 0.5; #use 0.8 for bpj-530, 0.5 for bpj-q50
huc10_tag = 'bpj-q50'
huc10_rawdata = 
  fn_dh_elfstats ( ftype = 'fe_elf',
    site = base_url, analysis_timespan = "full", yvar = yvar,
...
pander(ss6, table.split.table=Inf, caption='huc 6 R')
pander(ss8, table.split.table=Inf, caption='huc 8 R')
pander(ss10, table.split.table=Inf, caption='huc 10 R')
