...
# vars
yvar = 'aqbio_nt_minnow';#aqbio_nt_total, aqbio_nt_cent, aqbio_nt_darter, aqbio_nt_benins, aqbio_nt_minnow
quant = 0.8
ftype = 'nhd_huc6';
aftype = 'fe_elf';
dataset_tag = 'bpj-huc6-rcc';
sampres = "species";
rawdata = 
...
summary(fit)
  ...
  plot_monthly(anova_data, yvar, xmetric = 'out_rsq_adj', ymetric = yvar, ymin=0);
  
daqmean = subset(anova_data, in_xvar == 'nhdp_drainage_sqmi' | in_xvar == 'erom_q0001e_jan')
fit <- aov(out_rsq_adj ~ in_xvar, data=daqmean)
summary(fit) 
